...
export const routes: Routes = [
  ...
  {path: 'wallet', loadComponent: () => import('./components/wallet-list/wallet-list.component').then(m => m.WalletListComponent)},
  {
    path: 'events',
    loadComponent: () => import('./pages/event/event.page').then( m => m.EventPage)
  },
  { path: 'scan', loadComponent: () => import('./components/scan/scan.component').then(m => m.ScanComponent) },
  { path: 'event-dashboard/:id', loadComponent: () => import('./components/dashboard/dashboard.component').then(m => m.DashboardComponent) },
  {
    path: 'my-events',
